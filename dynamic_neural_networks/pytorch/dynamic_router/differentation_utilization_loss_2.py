...
for GEN_STRENGTH in [1e-1, 1]:
    for DIFF_STRENGTH in [1e-3]:
        for ENT_STRENGTH in [1]:
            ...
            LR_R = 1e-3
            LR_A = 5e-5
            NAME = f"differentation_{GEN_STRENGTH}_{DIFF_STRENGTH}_{ENT_STRENGTH}-sdigan-intensity-aux-reg-1-disc-3-experts"
