...
NAME = f"strat_helper_{STOP_ROUTER_CROSS_ENTROPY_EPOCH}_{STOP_ROUTER_TRAINING_EPOCH}" \
       f"_diff_expert_distribution_utilization_{ED_STRENGTH}_{GEN_STRENGTH}_{UTIL_STRENGTH}"
...
for _ in range(N_RUNS):
    ...
    print("Distribution of assigned labels", expert_number.value_counts())
    ...
    def train_step(batch, epoch):
        real_images, real_images_2, cond, std, intensity, true_positions, expert_assignments = batch
        ...
        expert_assignments = expert_assignments.to(device).clone()
        ...
        return gen_losses, \
               ...
               differentiation_loss.item(), expert_entropy_loss.item(), cross_entropy_loss.item()
    ...
    def train(train_loader, epochs, y_test):
        ...
        for epoch in range(epochs):
            ...
            for batch in train_loader:
                ...
                expert_entropy_loss, cross_entropy_loss = train_step(batch, epoch)
                ...
                cross_entropy_loss_epoch.append(cross_entropy_loss)
            ...
            log_data = {
                ...
                'cross_entropy_loss_epoch': np.mean(cross_entropy_loss_epoch),
    ...
    config_wandb = {
        ...
        'stop_router_cross_entropy_epoch': STOP_ROUTER_CROSS_ENTROPY_EPOCH,
