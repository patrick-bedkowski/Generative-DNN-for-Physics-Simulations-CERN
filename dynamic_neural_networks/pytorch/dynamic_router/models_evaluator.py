...
DATA_IMAGES_PATH = r"D:\GithubRepos\Generative-Models-for-CERN-Fast-Simulations\data\data_proton_photonsum_proton_1_2312.pkl"
DATA_COND_PATH = r"D:\GithubRepos\Generative-Models-for-CERN-Fast-Simulations\data\data_cond_photonsum_proton_1_2312.pkl"
DATA_POSITIONS_PATH = r"D:\GithubRepos\Generative-Models-for-CERN-Fast-Simulations\data\data_coord_proton_photonsum_proton_1_2312.pkl"
...
def evaluate_model(model_dir, model_name, output_dir):
    ...
    for i, filename in enumerate(generators_filenames):
        ...
        experts[i].load_state_dict(torch.load(gen_file, map_location=device))
...
if __name__ == "__main__":
    ...
    model_dir = r"C:\Users\PB\Documents\GithubRepos\Generative-DNN-for-Physics-Simulations-CERN\dynamic_neural_networks\pytorch\dynamic_router\experiments\Adaptive load balancing\test_continue_adaptive_load_balancing_2312_22_02_2025_15_34_57_576"
    epoch = 78
