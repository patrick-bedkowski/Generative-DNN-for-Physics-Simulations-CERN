...
NAME = f"test_alb_aux_different_gen_train_new_AUX"
...
for _ in range(N_RUNS):
    ...
    aux_reg_criterion = aux_regs[0].regressor_loss
    ...
    def generator_train_step(generator, discriminator, a_reg, cond, g_optimizer, a_optimizer, criterion,
        ...
        aux_reg_loss = aux_reg_criterion(true_positions, generated_positions)
